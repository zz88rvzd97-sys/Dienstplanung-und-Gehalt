...
(function () {
  ...
  const APP_VERSION = '1.23 FRV-Istzeit Fix';
...
function saveState(options = {}) {
  ...
  function normalizeFrvActualAssignment(entry) {
    ...
    if ((entry.plannedType === 'frv' || entry.actualType === 'frv_open') && entryHasActualService(entry)) {
      if (entry.actualType === 'frv_open') entry.actualType = 'frv_assigned';
