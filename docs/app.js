...
(function () {
  ...
  const APP_VERSION = '1.21 Tagesdienste Beta';
...
function renderRotation() {
  ...
  function serviceTimeText(entry) {
    ...
    if (entry.actualType === 'frv_open' || entry.plannedType === 'frv') return `FRV ${formatMinutes(entry.frvMinutes || state.settings.frvPlaceholderMinutes || 468)}`;
    return '—';
  }
